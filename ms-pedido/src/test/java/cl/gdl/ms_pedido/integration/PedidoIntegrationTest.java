...
public class PedidoIntegrationTest {
    ...
    void testInsertPedidoConDetalle() {
        ...
        pedido.setIdMedioDePago(UUID.fromString("e599cada-932b-4f44-9e01-5a09afe37942"));
        pedido.setIdEntrega(UUID.fromString("02a244a3-a3a8-445f-b311-2c40c8b8d4df"));
        pedido.setIdEstadoPedido(UUID.fromString("0ccd9100-cb4c-4373-817e-fc94cae2640f"));
